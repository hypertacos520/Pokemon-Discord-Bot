...
#Import Pokemon Data
pokemonDataSet = pd.read_csv(programDirectory + "/Pokemon.csv")
pokemonMovesDataSet = pd.read_csv(programDirectory + "/Moves.csv")
...
with open(programDirectory + '/botToken.txt', 'r') as file:
    botToken = file.read()
